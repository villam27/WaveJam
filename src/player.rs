...
fn init_player(mut command : Commands, asset_server: Res<AssetServer>, mut atlases: ResMut<Assets<TextureAtlas>>) {
	...
	body_animation_data.push(AData {start: 0, end: 0, frame_time: 0.15});
	body_animation_data.push(AData {start: 0, end: 3, frame_time: 0.15});
	head_animation_data.push(AData {start: 0, end: 0, frame_time: 0.25});
	head_animation_data.push(AData {start: 1, end: 1, frame_time: 0.25});
	head_animation_data.push(AData {start: 2, end: 2, frame_time: 0.25});
	head_animation_data.push(AData {start: 3, end: 3, frame_time: 0.25});
...
pub fn player_input(keys: Res<Input<KeyCode>>, time: Res<Time>,
...
pub fn change_head(keys: Res<Input<KeyCode>>,
